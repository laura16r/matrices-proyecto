...
class ParallelBlockIV4(AlgoritmoBase):
    """
    Algoritmo 12: Bloques paralelos Row×Row (sección IV.4 del artículo).

    Versión paralela de SequentialBlockIV3. Cada par de bloques (i1, k1)
    se procesa en un hilo independiente. El Lock garantiza que las
    escrituras sobre C[i1, k1] no generen condiciones de carrera.
